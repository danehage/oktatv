...
export default function Index() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4 max-w-md">
          ...
          <h2 className="text-xl font-semibold text-foreground">Failed to Load Videos</h2>
          <p className="text-muted-foreground">{error}</p>
          <Button onClick={refetch} className="bg-okta-blue hover:bg-okta-blue-dark">
  ...
  const featuredVideo: FeaturedVideo = videos.length > 0 ? {
    ...videos[0],
    isFeatured: true,
    heroImage: videos[0].thumbnail || 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=1920&h=1080&fit=crop',
    shortDescription: videos[0].description.length > 120
  ...
  const recentVideos = [...videos].sort((a, b) =>
        ...
        <div className="bg-destructive/10 border-l-4 border-destructive p-4 container mx-auto">
          <div className="flex items-center">
            ...
            <p className="text-sm text-destructive">
              ...
              <Button variant="link" onClick={refetch} className="ml-2 p-0 h-auto text-destructive">
                Retry loading
              </Button>
            </p>
          </div>
